...
from teeth_movement.isoclines import IsoclinesFilter
from teeth_movement.mesh_io import read_obj_teeth
from teeth_movement.utils import (angle, get_centroid, get_line_centroid,
                                  get_rotation_matrix, load_features, rotation,
                                  vector_l2_norm)
...
def get_symmetry_axis_circle_projection(
    ...
    for i in range(ANGLE_NUM):
        ...
        for j in range(rotation_values.shape[0]):
            ...
            dists.append(dist_to_circle_sum(
                R_2, center_2, points_rotated_proj[hull.vertices]))
