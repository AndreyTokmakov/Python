...
def time_chart():
    legend = 'TCP total'
    total_value = [33.7, 39.4, 43.8, 47.8, 52.7, 57.2,
                   61.8, 64.7, 65.2, 65.0, 63.5, 60.7,
                   57.2, 52.4, 47.2, 43.9, 39.3, 33.1]

    total_timestamps = [datetime.datetime(year=2022, month=1, day=31, hour=11, minute=14, second=15),
    ...
    tcp_values = [73.7, 73.4, 73.8, 72.8, 68.7, 65.2,
                  61.8, 58.7, 58.2, 58.3, 60.5, 65.7,
                  70.2, 71.4, 71.2, 70.9, 71.3, 71.1]

    tcp_timestamps = [datetime.datetime(year=2022, month=1, day=31, hour=11, minute=14, second=15),
                      datetime.datetime(year=2022, month=1, day=31, hour=11, minute=14, second=30),
                      datetime.datetime(year=2022, month=1, day=31, hour=11, minute=14, second=45),
                      datetime.datetime(year=2022, month=1, day=31, hour=11, minute=15, second=00),
                      datetime.datetime(year=2022, month=1, day=31, hour=11, minute=15, second=15),
    ...
    return render_template('time_chart.html',
                           total_value=total_value, total_timestamps=total_timestamps, legend=legend,
                           tcp_values=tcp_values, tcp_timestamps=tcp_timestamps, tcp_legend=tcp_legend,
                           )
